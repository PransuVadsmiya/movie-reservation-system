          ...
          >
            {movies.map((movie, idx) => (
              <motion.div
                ...
                onClick={() => router.push(`/movies/${movie.id}/showtimes`)}
                className="group relative rounded-2xl overflow-hidden aspect-[2/3] bg-[#151722] border border-white/5 cursor-pointer"
              >
                {movie.poster_url ? (
                  <img
